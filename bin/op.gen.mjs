...
binPath("tsx", "tsx/dist/cli.js").then((result) => {
  const cp = spawn(result, [
    fileURLToPath(new URL("../src/bin/op.ts", import.meta.url)),
  ...
  cp.on("close", (code, signal) => {
    if (typeof code === "number") {
      ...
      console.error("Failed to start", "op", signal);
    }
  });
}, onError);
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoib3AuZ2VuLm1qcyIsInNvdXJjZXMiOltdLCJzb3VyY2VzQ29udGVudCI6W10sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiI7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7Ozs7In0=
